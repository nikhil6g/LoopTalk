...
const ResetPassword = () => {
  ...
  const handleSendOtp = async () => {
    try {
      ...
      const { message } = await axios.post(
        `${import.meta.env.VITE_APP_API_BASE_URL}/api/user/generate-otp`,
        { email }
      );
      console.log(message);
      setTimeout(() => {
  ...
  const handleVerifyOtp = async () => {
    try {
      const { data } = await axios.post(
        `${import.meta.env.VITE_APP_API_BASE_URL}/api/user/verify-otp`,
        { email, otp }
      );
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const { message } = await axios.post(
        `${import.meta.env.VITE_APP_API_BASE_URL}/api/user/reset-password`,
        {
          email,
          otp,
          newPassword,
